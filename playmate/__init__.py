...
api.add_resource(EventDetail, '/event/<string:event_id>/detail')
api.add_resource(EventJoin, '/event/<string:event_id>/join')
api.add_resource(EventLeave, '/event/<string:event_id>/leave')
api.add_resource(EventClose, '/event/<string:event_id>/close')
